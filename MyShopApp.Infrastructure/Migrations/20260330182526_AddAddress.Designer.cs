...
namespace MyShopApp.Infrastructure.Migrations
{
    ...
    [Migration("20260330182526_AddAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyShopApp.Domain.Products.Product", b =>
                {
                    ...
                    b.Property<string>("Kilocalories")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MyShopApp.Domain.Users.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("DoorphoneNumber")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("HouseSectionNumber")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyShopApp.Domain.Users.User", b =>
                {
                    ...
                    b.Property<bool>("AllowPushEmails")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowPushNotifications")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowPushSms")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowSharingData")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MyShopApp.Domain.Users.UserAddress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyShopApp.Domain.Categories.Category", b =>
                {
                    b.HasOne("MyShopApp.Domain.ParentCategories.ParentCategory", "ParentCategory")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("MyShopApp.Domain.Users.UserAddress", b =>
                {
                    b.HasOne("MyShopApp.Domain.Users.Address", "Address")
                        .WithMany("UserAddresses")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyShopApp.Domain.Users.User", "User")
                        .WithMany("UserAddresses")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
